...
DEFAULT_AMSTO_ROOT = 'yahoodata'
DEFAULT_AMSTO_OUT = 'yahooout'
...
def from_yahoo():
    outputpath = os.path.join(os.path.pardir,'yahooout')
    datapath = os.path.join(os.path.pardir,'yahoodata')
    conf = munchify({
    "CSV_DATA_DIR": datapath,
    "OUTPUT_DIR": outputpath
    })
    return conf

def from_tushare():
    outputpath = os.path.join(os.path.pardir, 'tushareout')
    datapath = os.path.join(os.path.pardir, 'tusharedata')
    conf = munchify({
        "CSV_DATA_DIR": datapath,
        "OUTPUT_DIR": outputpath
    })
